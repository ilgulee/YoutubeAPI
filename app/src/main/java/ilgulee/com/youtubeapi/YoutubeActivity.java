...
//        ConstraintLayout constraintLayout=findViewById(R.id.youtube_player);
//        alternative way of inflating layout like above
...
//        we can instantiate youtube
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener=new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this,"Click Ad, make the video creator rich",Toast.LENGTH_LONG).show();
        }
        ...
        public void onVideoEnded() {
            Toast.makeText(YoutubeActivity.this,"Congratulation! You've completed another video",Toast.LENGTH_LONG).show();
        }
